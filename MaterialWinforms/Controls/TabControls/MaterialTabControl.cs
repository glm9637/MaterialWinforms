...
namespace MaterialWinforms.Controls
{
    ...
    public class MaterialTabPageCollectionEditor : System.ComponentModel.Design.CollectionEditor
    {

        public MaterialTabPageCollectionEditor(Type type)
            : base(type)
        {
        }
