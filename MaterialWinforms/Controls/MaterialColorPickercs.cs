...
{
    class MaterialColorPickercs : UserControl,IMaterialControl{
        [Browsable(false)]
        ...
        public MaterialColorPickercs()
        {
            Width = 250;
            Height = 425;

            //RedSlider = new MaterialColorSlider()
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            g.FillRectangle(new SolidBrush(pBaseColor), 0, 0, Width,(int)(Height * 0.66));
        }
    }
    ...
    class MaterialColorSlider : Control, IMaterialControl
    {
        ...
        public MaterialColorSlider(string pBeschreibung,Color pAccent)
        {
        ...
        protected override void OnMouseDown(MouseEventArgs e)
        {
            ...
            {
                MousePressed = true;
                if (e.X >= IndicatorSize / 2+BorderDistance && e.X <= Width - IndicatorSize / 2 - BorderDistance)
                {
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            g.DrawLine(LinePen, IndicatorSize / 2+BorderDistance, Height / 2 + (Height - IndicatorSize) / 2, Width - IndicatorSize / 2-BorderDistance*2, Height / 2 + (Height - IndicatorSize) / 2);

            if (Enabled)
            {
                g.DrawLine(SkinManager.ColorScheme.AccentPen, IndicatorSize / 2 + BorderDistance, Height / 2 + (Height - IndicatorSize) / 2, IndicatorRectangleNormal.X, Height / 2 + (Height - IndicatorSize) / 2);
            ...
            g.DrawString(Beschreibung, SkinManager.ROBOTO_MEDIUM_10, SkinManager.ColorScheme.TextBrush, new PointF(0, 0));
            g.DrawString(Value.ToString(), SkinManager.ROBOTO_MEDIUM_10, SkinManager.ColorScheme.TextBrush, new PointF(Width - g.MeasureString(Value.ToString(), SkinManager.ROBOTO_MEDIUM_10).Width / 2, 0f));
